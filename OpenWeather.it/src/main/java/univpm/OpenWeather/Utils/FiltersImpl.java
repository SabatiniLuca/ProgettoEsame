...
public class FiltersImpl implements FiltersInt {
	...
	/**
	 * Questo è il costruttore della classe che invoca il metodo @method getForecast del Service @WeatherImpl per generare un JSONObject 
	 * contenente un JSONArray con le previsioni.
	...
	/**
	 * Questo metodo restituisce un JSONArray con le previsioni meteo tra i due momenti richiesti start e finish.
	 * Sia start che finish devono avere un formato del tipo dd-MM-yyyy HH:mm per essere elaborati.
	 * Se l'orario (di start o finish) richiesto è compreso tra una previsione e l'altra (dato che vengono fatte ad intervalli di tre ore)
	 * la previsione andrà per eccesso nel caso di start e per difetto nel caso di finish.
	 * 
	 ...
	 * 
	 * @return printAll è un JSONObject con la descrizione dello start e finish della previsione e un JSONArray di previsioni ad intervalli di tre ore
	 * @author lucas
	 */
	...
	/**
	 * A scopo didattico si possono lasciare i setter e getters per usare questo metodo in altre circostanze. Il metodo funzionerà affinchè
	 * il JSONArray passato sarà strutturato come quello creato nel costruttore
	 * 
	 * @author lucas
	 */
	//setter e getter
