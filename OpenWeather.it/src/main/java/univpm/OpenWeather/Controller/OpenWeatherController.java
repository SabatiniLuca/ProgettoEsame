...
public class OpenWeatherController {
	 ...
	 * inserita, se non è inserita nessuna città la scelta di default sarà Milano.
	 * 
	 ...
	 */
	@GetMapping("/current")
	public ResponseEntity<Object> current(@RequestParam(name = "name", defaultValue = "Milano") String name)
			throws Exception {
		try {
	 ...
	 */
	@GetMapping("/forecast")
	public ResponseEntity<Object> forecast(@RequestParam(name = "name", defaultValue = "Milano") String name)
	...
	/**
	 * Questa rotta consente di salvare su file le previsioni meteo prese ogni ora.
	 * Su questi file saranno poi generate le statistiche.
	 * 
	...
	/**
	 * Questa rotta consente di visualizzare le statistiche riguardanti i valori
	 * massimi, minimi, la media e la varianza della pressione e delle temperature
	 * 
	...
	/**
	 * Questa rotta consente di visualizzare la soglia di errore delle temperatura
	 * corrente, massima e minima tra il forecast(previsioni per 5 giorni) e
	 * l'attuale(previsione giornaliera)
	 * 
	 * @param name nome della città della quale si vuole calcolare la soglia di
	 *             errore tra il forecast e l'attuale
	 * @return
	 ...
	 */
	@GetMapping("/errors")
	public ResponseEntity<Object> errors(@RequestParam(name = "name", defaultValue = "Milano") String name)
